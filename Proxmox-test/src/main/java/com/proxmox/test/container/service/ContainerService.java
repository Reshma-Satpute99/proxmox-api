package com.proxmox.test.container.service;
...
public class ContainerService {
	...
	@Autowired
	private com.proxmox.test.container.repository.LxcContainerRepository lxcContainerRepository;

	private final RestTemplate restTemplate;

	public ContainerService(RestTemplate restTemplate) {
	...
	public ResponseEntity<String> createLxc(com.proxmox.test.container.entity.LxcContainerDetails lxcContainerDetails) {
